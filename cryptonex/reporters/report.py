...
from cryptonex.domain.enums import Effort
...
def render_html(result: ScanResult) -> str:
    ...
    return f"""<!doctype html><html><head><meta charset="utf-8"><title>CRYPTONEX report — {_esc(result.target)}</title>
<style>
...
inputs X, Y and Z are configurable assumptions; CRYPTONEX does not predict the arrival date of a
